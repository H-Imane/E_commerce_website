...
<head>
  ...
  <title>Hora House | Sign Up</title>
...
<body>
  <div class="auth-page">
    <div class="auth-container">
      <div class="auth-header">
        <h1 class="auth-brand">Hora House</h1>
      ...
      <form class="auth-form" action="#" method="POST">
        ...
        <button type="button" id="signupButton" class="auth-submit-btn">Sign Up</button>
      </form>
      ...
      <p class="auth-switch-text">
        Already have an account? <a href="<?php echo $baseUrl; ?>/login.php" class="auth-switch-link">Sign in</a>
      </p>
    </div>
  </div>
  ...
  <script src="<?php echo $baseUrl; ?>/assets/js/auth.js" defer></script>
</body>
</html>
